...
- helper `.md`, `.html`, and printable variants under `assets/docs/` create unnecessary exposure in a static deploy
...
- remaining workstream gate: hosted preview smoke and sign-off using `assets/docs/PREVIEW_DEPLOY_SMOKE_CHECKLIST.md`
