...
- base: `main`
- release audit: `assets/docs/RELEASE_SCOPE_AUDIT.md`
- manifest: `assets/docs/DEPLOY_SCOPE_MANIFEST.md`
...
- Only the three PDF downloads under `assets/docs/` are runtime-critical. Printable HTML, Markdown source, and release-control docs should stay out of the minimal public stage set.
...
```powershell
git add -- assets/docs/DEPLOY_SCOPE_MANIFEST.md assets/docs/PREVIEW_DEPLOY_SMOKE_CHECKLIST.md assets/docs/RELEASE_PR_DESCRIPTION.md assets/docs/RELEASE_SCOPE_AUDIT.md assets/docs/RELEASE_STAGE_COMMANDS.md
```
...
3. Treat `assets/docs/PREVIEW_DEPLOY_SMOKE_CHECKLIST.md` as the final merge gate after preview deploy is live.
