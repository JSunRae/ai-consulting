...
- verified `assets/docs/PREVIEW_DEPLOY_SMOKE_CHECKLIST.md` still points at the current branch and current `HEAD`
- corrected `assets/docs/RELEASE_STAGE_COMMANDS.md` to use the actual npm preflight command
...
- the remaining merge gate is the Netlify preview deploy smoke check in `assets/docs/PREVIEW_DEPLOY_SMOKE_CHECKLIST.md`
