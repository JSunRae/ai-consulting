...
- release summary: `internal-docs/RELEASE_PR_DESCRIPTION.md`
- scope audit: `internal-docs/RELEASE_SCOPE_AUDIT.md`
- staging guide: `internal-docs/RELEASE_STAGE_COMMANDS.md`
- smoke evidence: `internal-docs/RELEASE_SMOKE_TEST_REPORT.md`
- preview gate: `internal-docs/PREVIEW_DEPLOY_SMOKE_CHECKLIST.md`
...
- staging and review procedure documented: `Yes`
  - `internal-docs/DEPLOY_SCOPE_MANIFEST.md` and `internal-docs/RELEASE_STAGE_COMMANDS.md` now act as the operational source of truth
- branch-level validation recorded: `Yes`
  - `internal-docs/BROWSER_QA_REPORT.md` records rendered browser QA
  - `internal-docs/RELEASE_SMOKE_TEST_REPORT.md` records release-candidate smoke results
