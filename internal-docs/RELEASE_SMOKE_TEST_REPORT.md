...
- Documentation updated: `internal-docs/RELEASE_SMOKE_TEST_REPORT.md`
...
- This does not conflict with the earlier desktop confirmation already recorded in `internal-docs/BROWSER_QA_REPORT.md`; the current release-candidate run still verified the CTA in a live rendered state.
