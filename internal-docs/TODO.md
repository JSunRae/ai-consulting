...
Use this file as the categorized open-work checklist for the isolated commercialization release branch. For branch-close status, defer to `internal-docs/WQ24_FINAL_STATUS.md`. For workstream posture and default decisions, defer to `internal-docs/WORKSTREAM_NEXT_STEPS.md`.
...
- [ ] **Complete hosted preview deploy sign-off** (`internal-docs/PREVIEW_DEPLOY_SMOKE_CHECKLIST.md`)
...
- [x] **Decide the production posting route for X and LinkedIn** (`internal-docs/SOCIAL_CONTENT_OPERATING_PLAN.md`, `scripts/social_buffer_publish.py`)
